...
| 2026-07-24 | M2 | Integrated per-fit PyDESeq2 fallback records and convergence counts | pending | diagnostic tests: `3 passed`; full suite: `97 passed, 22 warnings`; numerical/rank/filter acceptance remains |
