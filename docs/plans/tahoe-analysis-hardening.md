...
| 2026-07-24 | M4 | Started validated count-split adapter implementation | pending | cells x genes public contract, conservation, deterministic seed policy, and shared robust path |
