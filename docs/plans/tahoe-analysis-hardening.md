...
| 2026-07-24 | M1 | Reproduced byte-identical ordinary-fit numerical comparison | pending | stock `5196ce1c` and hardened `8d1c39f` produced identical beta, mu, H, alpha, and convergence JSON; pin gate remains |
