...
| 2026-07-24 | M1 | Added PyDESeq2 fallback decision record with exact commits, epsilon policy, and release-pin blocker | pending | `docs/decisions/001-pydeseq2-fallbacks.md`; immutable publication/approval remains required |
