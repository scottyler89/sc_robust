...
| 2026-07-24 | M3 | Added sparse-count support and integer-factor fixture; normalized sparse metadata weights | pending | boundary/count-split focused tests: `7 passed`; all eligible source IDs remain unique |
...
| 2026-07-24 | M4 | Added explicit negative-count and seed-bridge failure fixtures | pending | adapter tests: `4 passed`; deterministic, dense/sparse, and validation paths covered |
