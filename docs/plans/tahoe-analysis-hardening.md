...
| 2026-07-24 | M2 | Added annotation, rank, filtering, requested-pair, fallback, and terminal-failure fixtures | pending | design/diagnostic tests: `9 passed`; full suite: `102 passed, 24 warnings`; M1 dependency and ordinary numerical comparison remain |
